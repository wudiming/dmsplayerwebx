...
import { callKugou } from "../../kugou/index";
import type { KGSong } from "../../kugou/core/types";
import { getCachedLyric, setCachedLyric, buildFingerprint, getMatchedId, setMatchedId } from "../../../adapters/cache";
