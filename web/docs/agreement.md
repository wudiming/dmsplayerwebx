...
- 不得对本软件附加任何与 AGPL-3.0 相抵触的额外限制。
  ...
  3.4 本协议用于说明软件功能、第三方服务风险、商标与适用法律等事项，不限制 AGPL-3.0 已授予的权利。当本协议与 AGPL-3.0 存在冲突时，**以 AGPL-3.0 为准**。
...
10.1 **官方渠道**：本软件的官方版本信息与原始安装包发布于官方代码托管仓库，请认准官方渠道获取更新。
...
如对本协议有任何疑问、意见或需要反馈问题，您可通过官方代码托管仓库提交 Issue 或联系项目维护者。
