...
<template>
  <div class="flex flex-col gap-3">
    <div
      class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 rounded-xl bg-surface-panel border border-solid border-outline-variant/15 px-3.5 py-3 sm:px-4 sm:py-3.5"
    >
      ...
      <div class="shrink-0 flex items-center gap-2 self-end sm:self-auto flex-wrap">
